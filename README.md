...
## 📌 Tổng quan dự án
- **Bài toán**: Medical Image Segmentation (Binary Segmentation)
- **Dataset**: LGG MRI Segmentation Dataset (Kaggle)
- **Đóng góp chính**: 
  - Kết hợp **Mini Xception Encoder** với **Attention Gate** giúp tối ưu tham số (chỉ ~523K params)
  - Áp dụng **Combined Loss (Dice Loss + Binary Cross-Entropy)** để khắc phục mất cân bằng dữ liệu

## 📊 Kết quả huấn luyện
- **Validation Accuracy**: ~99.5%
- **Validation Dice Coefficient**: ~0.64
